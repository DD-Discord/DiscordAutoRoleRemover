...
- Stick to best practices for frameworks used. Research current best practices from documentation instead of purely relying on training data. Commit information about these to memory.
